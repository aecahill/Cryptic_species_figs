...
```{r}
summary(glm(CSss~as.character(HKKv3)*phylum_class,data=largeclasstable,family=binomial),test="Chisq")
```
...
```{r}
drop1(glm(CSss~hard_skeleton+phylum_class,data=surveymorpho,family=binomial),test="Chisq")
```
