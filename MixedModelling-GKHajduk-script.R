...
load("C:/Users/aecsk/Downloads/dragons.RData")
...
summary(mixed.lmer)
pt(0.422,df=1) #finding the p-value because apparently the model fit doesn't spit it out
...
339.7/(339.7+223.8) # var from mountains over total var
...
summary(mixed.lmer2) #the difference here is using the new variable, NOT the model syntax
### summary
