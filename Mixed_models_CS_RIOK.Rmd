---
title: "Mixed models for CS paper 2, RIOK = TRUE"
...
surveylarv<-filter(surveylarv, RIOK==TRUE) #N = 532, not sure why difference
```
...
```
NO EFFECT HERE, different from full dataset.
