...
palwes<-c("lightgrey","darkgrey","black")
...
alldataplot<-ggplot(as.data.frame(HKKtable2),aes(x=HKK,y=Percent,fill=Diff_type,))+
  ...
  annotate("text", x = 1, y = 0.9, label = "4", size = 4.5)+
  annotate("text", x = 2, y = 0.9, label = "37", size = 4.5)+
  annotate("text", x = 3, y = 0.9, label = "49", size = 4.5)+
  annotate("text", x = 4, y = 0.9, label = "49", size = 4.5)+
  annotate("text", x = 5, y = 0.9, label = "9", size = 4.5)+
  annotate("text", x = 6, y = 0.9, label = "11", size = 4.5)+
...
sedplot<-ggplot(as.data.frame(HKKtable2sed),aes(x=HKK,y=Percent,fill=Diff_type,))+
  ...
  theme_bw()+
  theme(axis.text.x = element_text(angle = 90))+ 
  annotate("text", x = 1, y = 0.05, label = "6", size = 3.5,color="white")+
  annotate("text", x = 2, y = 0.05, label = "2", size = 3.5,color="white")+
  annotate("text", x = 3, y = 0.05, label = "21", size = 3.5,color="white")+
  annotate("text", x = 4, y = 0.05, label = "13", size = 3.5,color="white")+
  annotate("text", x = 1, y = 0.95, label = "8", size = 3.5)+
  annotate("text", x = 2, y = 0.95, label = "6", size = 3.5)+
  annotate("text", x = 3, y = 0.95, label = "9", size = 3.5)+
  annotate("text", x = 4, y = 0.95, label = "2", size = 3.5)+
...
rockyplot<-ggplot(as.data.frame(HKKtable2rocky),aes(x=HKK,y=Percent,fill=Diff_type,))+
  ...
  theme(axis.text.x = element_text(angle = 90))+
  annotate("text", x = 1, y = 0.05, label = "6", size = 3.5,color="white")+
  annotate("text", x = 2, y = 0.05, label = "4", size = 3.5,color="white")+
  annotate("text", x = 3, y = 0.05, label = "6", size = 3.5,color="white")+
  annotate("text", x = 4, y = 0.25, label = "1", size = 3.5,color="white")+
  annotate("text", x = 1, y = 0.95, label = "21", size = 3.5)+
  annotate("text", x = 2, y = 0.95, label = "4", size = 3.5)+
  annotate("text", x = 3, y = 0.95, label = "18", size = 3.5)+
  annotate("text", x = 1, y = 0.4, label = "16", size = 3.5)+
