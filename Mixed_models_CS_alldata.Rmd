...
Sympatrygraph2<-ggplot(data = surveymorpho) +
  ...
  annotate("text", x = .65, y = .65, label = "117", size = 4.5,color="white")+
  annotate("text", x = .65, y = .15, label = "179", size = 4.5,color="white")+
...
Ecograph2<-ggplot(data = surveyeco) +
  ...
  annotate("text", x = .65, y = .65, label = "21", size = 4.5,color="white")+
  annotate("text", x = .65, y = .15, label = "86", size = 4.5,color="white")
