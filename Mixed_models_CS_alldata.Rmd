...
HKKtable2["HKK"][HKKtable2["HKK"] == "1"] <- "H001"
HKKtable2["HKK"][HKKtable2["HKK"] == "5"] <- "H005"
HKKtable2["HKK"][HKKtable2["HKK"] == "10"] <- "H010"
HKKtable2["HKK"][HKKtable2["HKK"] == "25"] <- "H025"
HKKtable2["HKK"][HKKtable2["HKK"] == "100"] <- "H100"
HKKtable2["HKK"][HKKtable2["HKK"] == "1000"] <- "H1000"

palwes<-c("black","darkgrey","lightgrey")


alldataplot<-ggplot(as.data.frame(HKKtable2),aes(x=HKK,y=Percent,fill=Diff_type,))+
  geom_bar(stat="identity")+
...
HKKtable2sed["HKK"][HKKtable2sed["HKK"] == "5"] <- "H005"
HKKtable2sed["HKK"][HKKtable2sed["HKK"] == "10"] <- "H010"
HKKtable2sed["HKK"][HKKtable2sed["HKK"] == "25"] <- "H025"
HKKtable2sed["HKK"][HKKtable2sed["HKK"] == "100"] <- "H100"
...
HKKtable2rocky["HKK"][HKKtable2rocky["HKK"] == "5"] <- "H005"
HKKtable2rocky["HKK"][HKKtable2rocky["HKK"] == "10"] <- "H010"
HKKtable2rocky["HKK"][HKKtable2rocky["HKK"] == "25"] <- "H025"
HKKtable2rocky["HKK"][HKKtable2rocky["HKK"] == "100"] <- "H100"
