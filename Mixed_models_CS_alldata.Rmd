...
```{r}
mat<-select(surveymorpho, c(Trop,Ntemp,Npol,Stemp,Spol, HKKv3, phylum_class, Sympatric,yearb,hard_skeleton,ferti,image,genitals, CSss))
mat[1:14]<-lapply(mat[1:14],as.factor)
